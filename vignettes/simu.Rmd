...
[Selection results over 1,000 simulation runs for various contamination rates whenp=  20.   Each  column  represents  a  contamination  rate.   The  horizontal  axis  representsthe  magnitude  of  outlyingness  and  the  vertical  axis  gives  the  TPR,  FPR  and  F1score,respectively <img src="plots_20.png" width="600"/>](plots_20.png)

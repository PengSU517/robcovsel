...
```{r do not run this chunck on a laptop}
library(inline)
...
readr::write_csv(as.data.frame(rst), "result_random_predictors.csv")
...
####### 20 predictors
result = as.data.frame(read_csv("result_random_predictors.csv")) 
glimpse(result)
...
mvtnorm::rmvnorm(100, mean = mu, sigma = sigma)[1,1]
